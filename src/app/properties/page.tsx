                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-md sticky top-28 z-30">
                            ...
                            <div className="mb-6">
                                ...
                                <Select
                                    ...
                                    options={[
                                        ...
                                        ...cities.filter(c => c !== 'All Cities').map(c => ({ value: c, label: c }))
                                    ]}
                                />
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <Select
                                    ...
                                    options={[
                                        ...
                                        ...propertyTypesFilter.filter(t => t !== 'All Types').map(t => ({ value: t, label: t }))
                                    ]}
                                />
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <Select
                                    ...
                                    onChange={(val) => setSelectedPriceRange(Number(val))}
